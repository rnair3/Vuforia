...
public class Parser
{
    public static List<float> gre;
    public static List<float> toefl;
    public static List<float> sop;
    public static List<float> lor;
    ...
    public static void Parse()
    {
        ...
        foreach (string line in lines)
        {
            ...
            else
            {
                ...
                firstPass = false;                                                             //The first line contains headers of the csv file so we need to avoid that
            }
